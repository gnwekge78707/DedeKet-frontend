  ...
  <div class="shoppingCart">
    ...
    <div class="cart-header">
      <div class="cart-header-content">
        <p>
          <i class="el-icon-shopping-cart-full" style="color:#11649C; font-weight: 600;"></i>
          我的购物车
        </p>
        <span>温馨提示：教材是否购买成功，以最终下单为准哦，请尽快结算</span>
      </div>
    </div>
    <!-- 购物车头部END -->
    ...
    <div class="content" v-if="getShoppingCart.length>0">
      ...
      <div class="cart-bar">
        <div class="cart-bar-left">
          <span>
            <router-link to="/subscription">继续购书</router-link>
          </span>
          <span class="sep">|</span>
...
.shoppingCart .cart-header {
  height: 64px;
  border-bottom: 2px solid #11649C;
